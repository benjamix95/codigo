...
import Logging
    ...
    public actor NetworkTransport: Transport {
        ...
        public func send(_ message: Data) async throws {
            ...
            // nonisolated(unsafe): the var is only ever read/written on @MainActor
            // but Swift 6 cannot prove it because the closure capture crosses
        ...
        private func receiveData() async throws -> Data {
            // nonisolated(unsafe): only accessed on @MainActor (see Task block below)
