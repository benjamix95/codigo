...
struct InlineToolTraceEventView: View {
    ...
    var body: some View {
        if let fileChange {
            ChatTurnInlineFileChangeRowView(
                change: fileChange,
                openPath: openPath,
                showsRunningChrome: showsRunningChrome,
                isError: MessageToolTraceView.isErrorType(event),
                isWarning: MessageToolTraceView.isWarningType(event),
