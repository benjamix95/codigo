...
/// Mirror NDJSON per la sessione debug Cursor `773578` (path fisso nel repo).
enum CursorDebugSession773578Log {
    static let sessionId = "773578"
    private static let logPath = "/Users/benjaminstoica/SoloCode/.cursor/debug-\(sessionId).log"
    private static let queue = DispatchQueue(label: "solo.cursor.debug.773578")
