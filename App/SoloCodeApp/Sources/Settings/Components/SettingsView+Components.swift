...
func settingsSectionHeader(title: String, subtitle: String, icon: String) -> some View {
    HStack(spacing: 12) {
...
func settingsFieldLabel(_ text: String) -> some View {
    Text(text).font(.system(size: 11, weight: .medium)).foregroundStyle(.secondary)
}

func settingsStatusBadge(connected: Bool, label: String) -> some View {
    HStack(spacing: 6) {
...
func settingsHintBox(_ text: String) -> some View {
    HStack(spacing: 8) {
