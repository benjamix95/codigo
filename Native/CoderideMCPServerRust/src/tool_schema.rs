    ...
    match name {
        ...
        "coderide_glob" => object_from_props(
            &[
                ...
                SchemaProp::with_desc("pathScope", "Optional base directory (alias)."),
                SchemaProp::with_desc("target_directories", "Optional base dir(s), comma-separated."),
        ...
        "coderide_find_files" => object_from_props(
            &[
                ...
                SchemaProp::with_desc("pathScope", "Optional directory scope (alias)."),
                SchemaProp::with_desc("target_directories", "Optional dirs, comma-separated."),
                SchemaProp::with_desc("targetDirectories", "Alias of target_directories."),
        ...
        "coderide_codebase_search" => object_from_props(
            &[
                ...
                SchemaProp::with_desc("pathScope", "Optional directory scope for search."),
                SchemaProp::with_desc("target_directories", "Optional dirs, comma-separated."),
                SchemaProp::with_desc("targetDirectories", "Alias of target_directories."),
            ],
            &["query"],
