    ...
    run_pattern_tool(
        ...
        &[
            (
                "disable_ssl",
                "warning",
                "SSL verificato disabilitato o simile.",
                "Abilita certificate pinning / validazione TLS.",
                0.82,
            ),
            (
                "allowsinvalidssl",
                "warning",
                "Invalid SSL consentito.",
            ...
            (
                "http://127.0.0.1",
                "suggestion",
                "HTTP verso localhost in codice.",
                "OK in dev; verifica non sia usato in release.",
                0.55,
            ),
            (
                " md5(",
                "warning",
                "MD5 per hash generico.",
                "Usa SHA-256+ per integrità security-sensitive.",
                0.68,
            ),
            (
                "exec(",
                "warning",
                "exec/eval dinamico potenzialmente pericoloso.",
                "Valida input e limita superficie.",
                0.74,
            ),
            (
                "sqlite3_exec",
                "suggestion",
                "Raw SQLite C API: rischio SQL injection se string concatenation.",
            ...
            (
                "print(",
                "suggestion",
                "Logging potenziale di dati sensibili (contesto).",
                "Evita PII in log produzione.",
                0.52,
            ),
        ],
