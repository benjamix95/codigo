...
- Sintomo: `SoloCodeAppCodeReviewCommandLoopTests.testDeferredReviewFailsWhenRustFinalizationRuntimeBecomesUnavailable` osservava snapshot persistita in fase `idle` invece che `completed`.
