...
- Sintomo:
  ...
  - tool canonici come `write`, `grep`, `todo_write`, `plan_create`, `debug_session`, `web_search` non passavano automaticamente a Rust anche con alias `coderide_*` gia' registrato.
