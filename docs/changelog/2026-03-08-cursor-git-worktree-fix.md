...
- Ripulito il metadata locale Git con `git worktree prune -v` per rimuovere l'entry stale `brave-proskuriakova` ancora puntata al vecchio path `/Users/benjaminstoica/SoloCode/...`.
