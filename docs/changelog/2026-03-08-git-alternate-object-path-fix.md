...
- Riallineati i file `objects/info/alternates` nei checkout SPM annidati in `.xcodebuild-test-1/2` dal vecchio root `/Users/benjaminstoica/codigo` al nuovo `/Users/benjaminstoica/SoloCode`.
