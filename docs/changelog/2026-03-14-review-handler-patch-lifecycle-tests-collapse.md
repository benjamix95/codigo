# 2026-03-14 — review handler patch lifecycle tests collapse

## Cosa cambia
- rimosso `CodeReviewHandlerTests+PatchLifecycle.swift`
- spostati in `CodeReviewHandlerTests+Helpers.swift`:
  - `testReviewRevalidateFindingQueuesCommand`
  - `testReviewRollbackPatchQueuesCommand`
  - `testReviewCloseFindingQueuesCommand`
