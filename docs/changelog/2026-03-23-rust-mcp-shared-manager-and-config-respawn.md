...
- La preferenza Rust-first e' stata estesa alle famiglie canoniche core (`review_*`, `web_*`, `audit_*`, `bughunter_*`, `security_*`, `subagent_*`, ecc.), cosi' il dispatch standard passa prima da `coderide_*` quando il registry e' caldo.
