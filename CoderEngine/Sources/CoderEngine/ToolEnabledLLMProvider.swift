...
public final class ToolEnabledLLMProvider: LLMProvider, @unchecked Sendable {
    ...
    private var toolProtocolPrompt: String {
        ...
        11. When done, provide a clear summary: what changed, which files, outcome.
        12. Do NOT stop until the task is fully resolved or you've clearly stated a blocker with next steps.
