    ...
    private func makeDescriptor() -> ProjectValidationDescriptor {
        ProjectValidationDescriptor(
            ...
            testGroups: [
                ...
                ValidationTestGroup(id: "app-runtime", bundle: "SoloCodeAppTests", pathPrefixes: ["App/SoloCodeApp/Sources/Runtime/"], onlyTesting: ["SoloCodeAppTests/PipelineIntegrationServiceTests"]),
            ]
        )
    }
}
