...
final class CLIProfileProvisionerTests: XCTestCase {
    ...
    func testCodexEnvironmentOverridesRepairsMissingMCPBlockInExistingConfig() throws {
        ...
        XCTAssertTrue(config.contains("required = true"))
    ...
    func makeTemporaryExecutable(named name: String) throws -> URL {
    ...
    func withMCPServerPathOverride<T>(_ path: String, operation: () throws -> T) rethrows -> T {
    ...
    func expectedCodexConfig(using binaryPath: String) -> String {
