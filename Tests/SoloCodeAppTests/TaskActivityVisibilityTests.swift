...
final class TaskActivityVisibilityTests: XCTestCase {
    ...
    func testConcreteFilterIncludesOperationalEvents() {
        ...
        XCTAssertTrue(TaskActivityStore.isConcreteVisibleEventType("coderide_todo_write"))
        XCTAssertTrue(TaskActivityStore.isConcreteVisibleEventType("plan_create"))
        XCTAssertTrue(TaskActivityStore.isConcreteVisibleEventType("coderide_plan_create"))
        ...
        XCTAssertTrue(TaskActivityStore.isConcreteVisibleEventType("coderide_debug_log"))
        XCTAssertTrue(TaskActivityStore.isConcreteVisibleEventType("subagent_text"))
        XCTAssertFalse(TaskActivityStore.isConcreteVisibleEventType("assistant_update"))
    }
