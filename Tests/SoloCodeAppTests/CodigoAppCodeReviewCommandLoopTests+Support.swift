...
func makeReviewPatchRuntimeResponse(
    isError: Bool,
    ...
    let payload: [String: Any] = [
        ...
        "runtimeId": runtimeId ?? NSNull(),
        "status": status,
        "currentStep": currentStep ?? NSNull(),
    ]
    let data = try! JSONSerialization.data(withJSONObject: payload)
    return try! JSONDecoder().decode(ReviewPatchRuntimeResponse.self, from: data)
}
