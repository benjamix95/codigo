...
enum CLIProfileProvisioner {
    ...
    private static func seedCodexConfigToml(at profileURL: URL, overwrite: Bool) {
        ...
        // Still self-heal MCP block and features for existing configs.
    ...
    private static func codexExperimentalFeaturesLines() -> [String] {
        [
            "[features]",
            "js_repl = true",
            "multi_agent = true",
    ...
    private static func upsertExperimentalFeaturesSection(in lines: [String]) -> [String] {
