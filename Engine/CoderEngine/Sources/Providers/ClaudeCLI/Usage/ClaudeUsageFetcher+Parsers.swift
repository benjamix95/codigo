...
extension ClaudeUsageFetcher {
    static func parseStreamJSON(_ text: String) -> ClaudeUsage? {
    ...
    /// ```
    static func parseLocalCommandStdout(_ content: String) -> ClaudeUsage? {
    ...
    static func extractLeadingNumber(from text: String) -> Int? {
    ...
    static func parseCostOutput(_ text: String) -> ClaudeUsage {
        var cost: String?
        var inTokens: Int?
        var outTokens: Int?
